...
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
knitr::include_graphics("img/tablero0.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align = "center"}
knitr::include_graphics("img/carrera.png")
```
 <br/>
...
boxplot(futbol$off, las=1, horizontal = TRUE, col = c11)
```
...
Supongaos que solo se nos dice que un grupo conformado por 4 personas tiene un promedio de edad de $20$ años. Todos inicialmente suponemos que se trata de cuatro jóvenes que tienen edades cercanas a $20$ años. Pero  puede ocurrir que estemos lejos de acertarlo, pues existen multiples combinaciones de edades que tienen como promedio $20$ años. 
...
knitr::include_graphics("img/ansiedad.png")
```
