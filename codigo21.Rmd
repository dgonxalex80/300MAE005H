...
# Colombia <- readRDS("~/Documentos/JAVERIANA/PERIODO-2025-2/repository/300MAE005H/data/Colombia.RDS")

Colombia23 <- readRDS("~/Documentos/JAVERIANA/PERIODO-2025-2/repository/300MAE005H/data/Colombia23.RDS")
Colombia23$ubicacion=str_to_upper(Colombia23$ubicacion)
Colombia23$estado=str_to_upper(Colombia23$estado)
