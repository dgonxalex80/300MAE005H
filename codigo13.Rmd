...
knitr::include_graphics("img/codigo01.png")
```
...
par(oma = c(3, 5, 2, 4) )  # margenes de la imagen
boxplot((nf~cc),main="Nota final matemáticas fundamentales por carrera", 
        col=c("#066d8d","#34b5aa","#ecbe14"), names=labs, xlab = "nota", ylab = " ", 
        horizontal = TRUE,
        las=1)
abline(v=3, col="#f69312", lwd=2)
abline(v=4, col="#447270", lwd=2)
```
...
<a href="https://raw.githubusercontent.com/dgonxalex80/300MAE005H/main/pdf/tablero-01.Rmd" download>
  <button style="background-color:c51; color:white; padding:7px 20px; border:none; border-radius:5px; cursor:pointer;">
